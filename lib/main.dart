import 'package:basic_navigation/firebase_options.dart';
import 'package:basic_navigation/screens/calendarpage.dart';
import 'package:basic_navigation/screens/medalspage.dart';
...
import 'package:basic_navigation/screens/classificapage.dart';
    ...
    return ChangeNotifierProvider<EventProvider>(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          'leaderboard':(context) => ClassificaPage(),
          'medals':(context )=> MedalsPage(),
